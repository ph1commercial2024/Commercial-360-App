...
// ─── DESIGN TOKENS ────────────────────────────────────────────────────────────
const C = {
  coral:      "#E5503A",   // PH1 coral — primary CTA + logo mark only
  coralDark:  "#B03020",
  coralLight: "#FDF1EF",
  coralMid:   "#F5D5CF",
  black:      "#000000",
  brandDark:  "#111827",   // near-black — header & sidebar
  mahogany:   "#1F2937",
  white:      "#FFFFFF",
  offWhite:   "#F9FAFB",   // near-white body
  surface:    "#F3F4F6",
  border:     "#E5E7EB",
  borderMid:  "#D1D5DB",
  textPri:    "#111827",
...
const styles = {
  ...
  navItem: (active, collapsed) => ({
    ...
    background: active ? "#E5503A" : "transparent",
    border: "none",
    boxShadow: active ? "0 2px 10px rgba(229,80,58,0.35)" : "none",
    marginBottom: 2, transition: "background 0.12s, color 0.12s, box-shadow 0.12s",
  ...
  btnPrimary: {
    ...
    boxShadow: "0 2px 10px rgba(229,80,58,0.3), 0 1px 2px rgba(229,80,58,0.2)",
  },
  btnSecondary: {
    background: "transparent", color: C.textPri, border: `1.5px solid ${C.border}`,
